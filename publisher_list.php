...
?>
	...
	?>
		<li>
		    ...
		    <a style="color: darkblue" href="bookPerPub.php?pubid=<?php echo $row['publisherid']; ?>"><?php echo $row['publisher_name']; ?></a>
		</li>
	<?php } ?>
		<li>
			<a style="color: red" href="books.php">List full of books</a>
		</li>
	</ul>
<?php
	mysqli_close($conn);
